...
$(MUSIC): $(OBJECTS_MU) $(HEADER) $(LIBFT)/libft.a
	...
	cp ./images/magic_walls/halloween_w.png ./images/magic_walls/magic_wall_w.png
	@echo "Welcome to the Halloween map!"
...
download_mlx42:
	...
	@echo "Now try: $$ make && ./$(NAME) ./map/map00.cub"
...
download_music:
	$(GIT_MUSIC)
	@echo "Now try: $$ make music && ./$(MUSIC) ./map/map10.cub"

delete_music:
	rm -rf $(LIBMUSIC)

.PHONY:	all bonus music clean fclean re libmlx
